// Hypothetical weights based on public analysis and typical recommender systems
...
pub const WEIGHTS_SUM: f64 = FAVORITE_WEIGHT + REPLY_WEIGHT + RETWEET_WEIGHT + PHOTO_EXPAND_WEIGHT + CLICK_WEIGHT + PROFILE_CLICK_WEIGHT + VQV_WEIGHT + SHARE_WEIGHT + SHARE_VIA_DM_WEIGHT + SHARE_VIA_COPY_LINK_WEIGHT + DWELL_WEIGHT + QUOTE_WEIGHT + QUOTED_CLICK_WEIGHT + CONT_DWELL_TIME_WEIGHT + FOLLOW_AUTHOR_WEIGHT; // Simplified sum of positives

pub const NEGATIVE_WEIGHTS_SUM: f64 = NOT_INTERESTED_WEIGHT + BLOCK_AUTHOR_WEIGHT + MUTE_AUTHOR_WEIGHT + REPORT_WEIGHT;
